 ...
 */
/**
 * Emitted when the user is logged in
 * @event Identity#login
 */
/**
 * Emitted when the user is logged out
 * @event Identity#logout
 */
/**
 * Emitted when the user is not logged in // FIXME should be more specific
 * @event Identity#notLoggedin
 */
/**
 * Emitted when the session is changed // FIXME should be more specific
 * @event Identity#sessionChange
 */
/**
 * Emitted when the session is initialized // FIXME should be more specific
 * @event Identity#sessionInit
 */
/**
 * Emitted when the user status changes // FIXME should be more specific
 * @event Identity#statusChange
 */
/**
 * Emitted when the user is changed // FIXME should be more specific
 * @event Identity#userChange
 */
/**
 * Emitted when we have a visitor // FIXME should be more specific
